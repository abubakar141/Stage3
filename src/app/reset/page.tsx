            ...
            <div className="left-top flex h-full">
                ...
                <div style={styles.loginContainer}>
                    ...
                    <div className="box p-4 w-full max-w-sm">
                        <center>
                            <h2 className="text1 mb-3 text-lg m-3 ml-6 ">Reset password</h2>
                            <p className="text2 mb-3  text-gray-700 text-sm m-3 ml-6">Enter your email address to get instructions for resetting your password.</p>
                        </center>
                        ...
                        <form action="" onSubmit={handleSubmit}>
                            <div className="container space-y-3">
                                ...
                                <div className="mt-3">
                                    <button className="button text- text-sm  rounded-full text-white" type="submit">Reset Password</button>
                                </div>
                            </div>
                        </form>
