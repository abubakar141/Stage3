            ...
            <div className="left-top flex h-full">
                ...
                <div style={styles.loginContainer}>
                    ...
                    <div className="box p-4 w-full max-w-sm">
                        <center>
                            <h2 className="text1 mb-2 text-lg m-3 ml-6">Get started with Franchain</h2>
                            <p className="text2 mb-3 text-gray-700 text-sm ml-6">Create an account in 5 minutes.</p>
                        </center>
                        ...
                        <p className="hi text-gray-700 mt-3 text-left mb-14 ml-6">
